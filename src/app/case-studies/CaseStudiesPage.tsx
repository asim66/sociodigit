...
const CaseStudies = () => {
  const cases = [
    ...
    {
      title: "Digital Presence & Cloud Migration",
      client: "Hotel Holiday Resort",
      category: "Digital Marketing",
      image: "https://picsum.photos/seed/case-4/800/600",
      problem: "The resort was losing bookings due to fake ads, GMB spam, and suffered from a slow website on shared hosting.",
      strategy: "Executed comprehensive SEO & ORM. We blocked fake ads, maintained regular GMB updates to keep data secure from spammers, and migrated the website to a high-performance cloud server.",
      results: ["Fake ads completely blocked", "Local search visibility increased via GMB updates", "Seamless cloud migration with zero downtime"],
      metrics: [
        { label: "Brand Protection", value: "100%" },
        { label: "Site Speed", value: "+80%" }
      ]
    }
  ];
