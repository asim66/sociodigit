...
import { 
  ...
  CheckCircle2, ArrowRight, Zap, Globe, Database, 
  Settings, BarChart, Layout, Smartphone, ChevronRight
} from 'lucide-react';
...
const Services = () => {
  const serviceCategories = [
    ...
    },
    {
      ...
      icon: <Cpu size={40} />,
      desc: "Strategic technology planning and architecture design to ensure your product is built for scale.",
      benefits: ["Cost Optimization", "Risk Mitigation", "Strategic Roadmap", "Tech Audit"],
      tech: ["System Design", "Cloud Strategy", "MVP Planning", "Security Audit"],
      process: ["Analysis", "Strategy", "Roadmap", "Execution Support"]
    },
    {
      id: "qa",
      ...
      icon: <Shield size={40} />,
      desc: "Comprehensive testing services to ensure your software is bug-free and performs under pressure.",
    ...
    },
    {
      ...
      icon: <Search size={40} />,
      desc: "Data-driven marketing strategies to grow your user base and increase your ROI.",
      benefits: ["High-Quality Leads", "Brand Authority", "Increased Traffic", "Better Conversion"],
      tech: ["SEO", "PPC", "Meta Ads", "Content Strategy"],
      ...
      <section className="section-padding">
        <div className="container-custom space-y-32">
          {serviceCategories.map((service, index) => (
            <div key={service.id} id={service.id} className={`grid lg:grid-cols-2 gap-20 items-center ${index % 2 !== 0 ? 'lg:flex-row-reverse' : ''}`}>
              <motion.div 
