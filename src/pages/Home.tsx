           ...
           <div className="space-y-20 md:space-y-32">
             ...
             >
               <div className="md:w-1/2 mb-6 md:mb-0">
                 <div className="text-5xl sm:text-7xl lg:text-9xl font-display font-black text-transparent bg-clip-text bg-gradient-to-br from-white to-white/20 leading-none drop-shadow-2xl">
                   ₹50<span className="text-brand-orange">M</span>+
                 </div>
               </div>
             ...
             >
               ...
               <div className="md:w-1/2 mb-2 md:mb-0 order-1 md:order-2 md:text-right flex justify-center md:justify-end">
                 <div className="text-5xl sm:text-7xl lg:text-9xl font-display font-black text-transparent bg-clip-text bg-gradient-to-bl from-indigo-400 to-indigo-900 leading-none drop-shadow-2xl">
                   50<span className="text-white">M</span>+
                 </div>
               </div>
             </motion.div>
           </div>
            ...
            {services.map((service, index) => (
              ...
              >
                ...
                <div className="flex items-center justify-between mt-auto">
                  <Link to={service.path} className="inline-flex items-center font-bold text-brand-orange group-hover:translate-x-2 transition-transform relative z-10">
